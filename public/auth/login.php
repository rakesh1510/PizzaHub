...
if($_SERVER['REQUEST_METHOD']==='POST'){
 ...
 if($u && password_verify($_POST['password'],$u['password_hash'])){session_regenerate_id(true);$_SESSION['user']=['id'=>$u['id'],'name'=>$u['name'],'email'=>$u['email'],'role'=>$u['role']];header('Location: ../index.php');exit;}
 $msg='Invalid login';
}
?>
